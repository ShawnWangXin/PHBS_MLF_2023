...
def main(args):
    ...
    train_dataset = Dataset('20210101', '20221231', args.model_name, args.matrix_dir,'train')
    valid_dataset = Dataset('20230101', '20230630', args.model_name, args.matrix_dir,'valid')
    test_dataset = Dataset('20230701', '20231231', args.model_name, args.matrix_dir,'test')
...
def parse_args():
    ...
    parser.add_argument('--matrix_dir', type=str, default ='./data/matrix_sac_txt_vector_QE2')
